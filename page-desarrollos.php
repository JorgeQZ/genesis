...
<div class="contenedor-general-desarrollos">
    ...
    <div class="contenedor-general-desarrollo">
        <div class="contenedor-desarrollo">
            <img class="logo-esq" src="<?php echo get_template_directory_uri().'/img/ancora.png'?>" alt="">
            <div class="cont-info">
            <!--    <img src="<?php echo get_template_directory_uri().'/img/ancora.png'?>" alt=""> -->
                <div class="info">
                    ...
                    <a class="link-desarrollo" href="#">ver desarrollo</a>
                </div>
    ...
    <div class="contenedor-general-desarrollo">
        <div class="contenedor-desarrollo">
            <img class="logo-esq" src="<?php echo get_template_directory_uri().'/img/montalva.png'?>" alt="">
            <div class="cont-info">
                <div class="info">
                    <h1>Montalva Residencial</h1>
                    <p>Precios Desde: <span>$3.000.000</span></p>
                    <p class="ubicacion">  Av. Sor Juana Inés de la Cruz 312, <br> Tlalnepantla Estado de México.</p>
                    <div class="detalles">
                        <div>
            ...
            <div class="cont-media">
                <div class="desarrollo-slider owl-carousel owl-theme">
                    <div class="item">
                        <img src="<?php echo get_template_directory_uri().'/img/montalva-slide.jpg'?>" alt="">
                    </div>
                    <div class="item">
                        <img src="<?php echo get_template_directory_uri().'/img/montalva-slide.jpg'?>" alt="">
                    </div>
    ...
    <div class="contenedor-general-desarrollo">
        <div class="contenedor-desarrollo">
            <img class="logo-esq" src="<?php echo get_template_directory_uri().'/img/tlanepantla.png'?>" alt="">
            <div class="cont-info">
                <div class="info">
                    <h1>Puerta Tlanepantla</h1>
                    <p>Precios Desde: <span>$3.000.000</span></p>
                    <p class="ubicacion">   Av. Sor Juana Inés de la Cruz 312, <br> Tlalnepantla Estado de México.</p>
                    <div class="detalles">
                        <div>
            ...
            <div class="cont-media">
                <div class="desarrollo-slider owl-carousel owl-theme">
                    <div class="item">
                        <img src="<?php echo get_template_directory_uri().'/img/tlanepantla-slide.jpg'?>" alt="">
                    </div>
                    <div class="item">
                        <img src="<?php echo get_template_directory_uri().'/img/tlanepantla-slide.jpg'?>" alt="">
                    </div>
    ...
    <div class="contenedor-general-desarrollo">
        <div class="contenedor-desarrollo">
            <img class="logo-esq" src="<?php echo get_template_directory_uri().'/img/bolognia.png'?>" alt="">
            <div class="cont-info">
                <div class="info">
                    <h1>Bolognia Residencial</h1>
                    <p>Precios Desde: <span>$3.000.000</span></p>
                    <p class="ubicacion">  Av. Sor Juana Inés de la Cruz 312, <br> Tlalnepantla Estado de México.</p>
                    <div class="detalles">
                        <div>
            ...
            <div class="cont-media">
                <div class="desarrollo-slider owl-carousel owl-theme">
                    <div class="item">
                        <img src="<?php echo get_template_directory_uri().'/img/bolognia-slide.jpg'?>" alt="">
                    </div>
                    <div class="item">
                        <img src="<?php echo get_template_directory_uri().'/img/bolognia-slide.jpg'?>" alt="">
                    </div>
